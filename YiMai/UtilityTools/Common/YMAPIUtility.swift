...
public class YMAPIInterfaceURL {
    ...
    static let UpdateAppointmentDetail = YMAPIInterfaceURL.ApiBaseUrl + "/appointment/update"
    ...
    static let GetAllNewAdmissionMsg = YMAPIInterfaceURL.ApiBaseUrl + "/msg/admissions/all"
...
public class YMAPIUtility {
    ...
    public func YMUpdateAppointmentDetail(param: AnyObject) {
        print(param)
        YMAPIPost(YMAPIInterfaceURL.UpdateAppointmentDetail, param: param, progressHandler: nil)
    }
    ...
    public func YMGetAllNewAdmissionMsg() {
        YMAPIGet(YMAPIInterfaceURL.GetAllNewAdmissionMsg, param: nil, progressHandler: nil)
    }
