...
public class YMCommonStrings {
    public static let CS_HOME_LABEL_TITLE = "主页"
    public static let CS_YIMAI_LABEL_TITLE = "医脉"
    public static let CS_PERSONAL_LABEL_TITLE = "个人"
    
    public static let CS_PAGE_INDEX_NAME = "PageIndex"
    ...
    public static let CS_PAGE_APPOINTMENT_TRANSFER = "PageAppointmentTransfer"
    ...
    public static let CS_API_PARAM_KEY_NAME = "name"
}
