...
public class PageForgetPasswordBodyView: PageBodyView {
    ...
    private func DrawSubmitButton() {
        ...
        SubmitButton?.setBackgroundImage(UIImage(named: "CommonXLButtonBackgroundGray"), forState: UIControlState.Disabled)
        SubmitButton?.setBackgroundImage(UIImage(named: "CommonXLButtonBackgroundBlue"), forState: UIControlState.Normal)
