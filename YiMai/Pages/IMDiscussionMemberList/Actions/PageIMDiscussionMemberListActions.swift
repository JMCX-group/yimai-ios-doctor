//
//  PageIMDiscussionMemberListActions.swift
//  YiMai
//
...
class PageIMDiscussionMemberListActions: PageJumpActions {
    var TargetView: PageIMDiscussionMemberListBodyView!
    var GetInfoApi: YMAPIUtility!

    override func ExtInit() {
        super.ExtInit()
        
        TargetView = Target as! PageIMDiscussionMemberListBodyView
